...
/**
 * Created by wangxiaojian on 16/4/22.
 */
public class RoundProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Log.e("centreText",centreText+"");
        float textWidth = paint.measureText(centreText);   //测量字体宽度，我们需要根据字体的宽度设置在圆环中间
        canvas.drawText(centreText, centre - textWidth / 2, centre + textSize/2, paint); //画出进度百分比,重新加载
